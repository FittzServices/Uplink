...
class TestimonyCarouselMobile extends StatefulWidget {
  @override
  _TestimonyCarouselMobileState createState() => _TestimonyCarouselMobileState();
}

class _TestimonyCarouselMobileState extends State<TestimonyCarouselMobile> {
  int _current = 0;
